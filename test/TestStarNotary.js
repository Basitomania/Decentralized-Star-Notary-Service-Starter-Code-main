...
it('lets user2 buy a star and decreases its balance in ether', async() => {
    ...
    await instance.buyStar(starId, {from: user2, value: balance, gasPrice:10000000});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let user2 = accounts[2];
    let starId = 10;
    await instance.createStar('Fresh Star', starId, { from: user1 });
    assert.equal(await instance.lookUptokenIdToStarInfo.call(starId), 'Fresh Star')
});